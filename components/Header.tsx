...
const Header: React.FC = () => {
  ...
  return (
    <header
      className="sticky top-0 z-50 bg-white/80 dark:bg-dark-bg/80 backdrop-blur-md border-b border-white/20 dark:border-dark-card/20 shadow-lg transition-all duration-300"
    >
